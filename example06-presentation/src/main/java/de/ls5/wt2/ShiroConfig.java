...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
        ...
        chainDefinition.put("/logout.jsp", "logoutFilter");

        // configuration for stateless authentication on each request
        chainDefinition.put("/rest/auth/users", "anon");
        chainDefinition.put("/rest/auth/admin/**", "anon");

        // configuration for stateless authentication on each request
        chainDefinition.put("/rest/auth/**", "restAuthenticator");

        // make other examples not require authentication
        chainDefinition.put("/rest/**", "restAuthenticator");
